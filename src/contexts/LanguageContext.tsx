...
const translations = {
  ...
  kn: {
    ...
    'workflow.subtitle': 'ನಿಮ್ಮ ಸರ್ಕಾರಿ ನಮೂನೆಗಳನ್ನು ಭರ್ತಿ ಮಾಡಲು ಸರಳ 3-ಹಂತದ ಪ್ರಕ್ರಿಯೆ',
    ...
    'workflow.step3': 'ನಿಮ್ಮ ನಮೂನೆಯನ್ನು ಸಿದ್ಧಗೊಳಿಸಿ',
    'workflow.step3Desc': 'ಸಲ್ಲಿಸಲು ಸಿದ್ಧವಾದ ನಿಮ್ಮ ಪೂರ್ಣಗೊಂಡ ನಮೂನೆಯನ್ನು ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ',
